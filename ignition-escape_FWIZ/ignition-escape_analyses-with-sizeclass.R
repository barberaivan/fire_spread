...
smodel_sizeclass <- stan_model(file.path("ignition-escape_FWIZ", "escape_model_ordinal.stan"))
scmod <- sampling(
...
min(sscmod[, "n_eff"], na.rm = T) # 2652.897
max(sscmod[, "Rhat"], na.rm = T)  # 1.004428

...
source(file.path("spread", "mcmc_functions.R"))
...
# limits for stepsU
Umin <- ceiling(max(Ytry["steps", , ])) + 0.001
...
# Ytry contains contrained steps samples
...
# saveRDS(
#   stansteps,
#   file.path("files", "hierarchical_model_FWIZ", "steps_model_stan_samples.rds")
# )
stansteps <- readRDS(
  file.path("files", "hierarchical_model_FWIZ", "steps_model_stan_samples.rds")
)
...
Sys.time()
# start: 2024-11-22 17:18:21 -03
# end:   2024-11-23 18:47:17 -03
...
# [1,]  9121.388  5339.085 0.9999466
# [2,] 12072.619 12460.370 1.0021859

# [1] "rho"
#      ess_tail  ess_bulk      rhat
# [1,] 10871.22  9013.168 0.9998171
# [2,] 11943.66 12225.335 1.0007124

# [1] "ranef"
#       ess_tail  ess_bulk      rhat
# [1,]  1248.817  1516.594 0.9996411
# [2,] 12246.201 12757.719 1.0100902

# [1] "steps"
#      ess_tail ess_bulk      rhat
# [1,] 10629.68 10443.51 0.9997156
# [2,] 12287.92 12627.97 1.0009024

# [1] "stepsU"
#      ess_tail ess_bulk      rhat
# [1,] 11777.32 12186.05 0.9998493
...
ggsave("spread/figures_FWIZ2/pairs_plot_correlations_posteriors.png",
       plot = plot_cor,
       width = 22, height = 20, units = "cm")
ggsave("spread/figures_FWIZ2/pairs_plot_correlations_posteriors.pdf",
       plot = plot_cor,
       width = 22, height = 20, units = "cm")
...
ggsave("spread/figures_FWIZ2/params_fwi_regression.png",
       width = 17, height = 10, units = "cm")
ggsave("spread/figures_FWIZ2/params_fwi_regression.pdf",
       width = 17, height = 10, units = "cm")
...
for(j in 1:npost) {
  steps2_draws[, j] <- invlogit_scaled(draws$steps[, j], 
                                       stepsL, draws$stepsU[j])
} 
...
ggsave("spread/figures_FWIZ2/steps_fwi_area.png",
       plot = fig_steps_area,
       width = 17, height = 15, units = "cm")
ggsave("spread/figures_FWIZ2/steps_fwi_area.pdf",
       plot = fig_steps_area,
       width = 17, height = 15, units = "cm")
...
ggsave("spread/figures_FWIZ2/spread_prob_curves.png",
       width = 14, height = 12, units = "cm")
ggsave("spread/figures_FWIZ2/spread_prob_curves.pdf",
       width = 14, height = 12, units = "cm")
...
ggsave("spread/figures_FWIZ2/flammability_indices.png",
       width = 14, height = 12, units = "cm",
       plot = fi_fig)
ggsave("spread/figures_FWIZ2/flammability_indices.pdf",
       width = 14, height = 12, units = "cm",
       plot = fi_fig)
...
ggsave("spread/figures_FWIZ2/spread_prob_curves_raw_x.png",
       width = 14, height = 18, units = "cm",
       plot = rawx_fig)
ggsave("spread/figures_FWIZ2/spread_prob_curves_raw_x.pdf",
       width = 14, height = 18, units = "cm",
       plot = rawx_fig)
...
size_obs <- readRDS(file.path("files", "hierarchical_model_FWIZ", "size_obs.rds"))
veg_available <- readRDS(file.path("files", "hierarchical_model_FWIZ", "veg_available.rds"))
...
ggsave("spread/figures_FWIZ2/overlap_fit_sim.png",
       width = 9, height = 12, units = "cm")
ggsave("spread/figures_FWIZ2/overlap_fit_sim.pdf",
       width = 9, height = 12, units = "cm")
...
ggsave("spread/figures_FWIZ2/dharma_size_fit_sim.png",
       width = 15, height = 13, units = "cm")
ggsave("spread/figures_FWIZ2/dharma_size_fit_sim.pdf",
       width = 15, height = 13, units = "cm")
...
ggsave("spread/figures_FWIZ2/quotient_sim_obs_fire_size.png",
       width = 15, height = 16, units = "cm")
ggsave("spread/figures_FWIZ2/quotient_sim_obs_fire_size.pdf",
       width = 15, height = 16, units = "cm")
